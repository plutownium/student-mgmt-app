...
import { isInteger, isNonEmptyString, isStringInteger, isValidGrade } from "../validation/inputValidation";
...
class ResultController {
    ...
    constructor(resultService: ResultService) {
        ...
        this.router.get("/all", this.getAllResults.bind(this));
    ...
    public async addNewResult(request: Request, response: Response) {
        try {
            ...
            const courseId = isInteger(courseIdInput);
            const studentId = isInteger(studentIdInput);
